...
<tr>
  <td nowrap align=right valign=top style="padding-right:5;" class=ver7>file # 1</td>
  <td width=100% align=left><input type=file name=file1 class=input2 style="width:100%;height:21;"><?=$file_name1?>
  </td>
</tr>

<tr>
  <td nowrap align=right valign=top style="padding-right:5;" class=ver7>file # 2</td>
