...
<tr>
  <td width=60 nowrap align=right style="padding-right:5;"><font style='font-family:verdana;font-size:7pt;'>Option</font></td>
  <td align=left><?=$category_kind?>
<font style='font-family:verdana;font-size:7pt;'><?=$hide_notice_start?> <input type=checkbox name=notice <?=$notice?> value=1>Notice<?=$hide_notice_end?>
<?=$hide_html_start?> <input type=checkbox name=use_html <?=$use_html?> value=1>Html<?=$hide_html_end?> 
<?=$hide_secret_start?><input type=checkbox name=is_secret <?=$secret?> value=1>Secret</td><?=$hide_secret_end?></font>
      </tr>
